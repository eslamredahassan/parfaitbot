...
module.exports = async (client, config) => {
  ...
  client.on("interactionCreate", async (interaction) => {
        ...
        case "#forward_reply":
          {
            ...
            let forward_reply_modal = new Modal()
              .setTitle(`Send message to ${user.user.username}`)
              .setCustomId(`forward_reply_modal`);
            ...
            forward_reply_modal.addComponents(row_reply);

            await interaction.showModal(forward_reply_modal);
          }
        default:
          break;
      }
    ...
    if (interaction.customId === 'forward_reply_modal') {
